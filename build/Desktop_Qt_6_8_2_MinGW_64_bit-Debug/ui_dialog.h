...
public:
    ...
    QLabel *label16_2;
    QDoubleSpinBox *dialogInputMeanMobilityPerDay;
    QLabel *label17_2;
    QLabel *label22;
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        dialogInputMeanMobilityPerDay = new QDoubleSpinBox(agentPageDialog);
        dialogInputMeanMobilityPerDay->setObjectName("dialogInputMeanMobilityPerDay");
        dialogInputMeanMobilityPerDay->setEnabled(false);
        dialogInputMeanMobilityPerDay->setGeometry(QRect(120, 110, 91, 30));
        dialogInputMeanMobilityPerDay->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        dialogInputMeanMobilityPerDay->setLocale(QLocale(QLocale::German, QLocale::Belgium));
        dialogInputMeanMobilityPerDay->setMinimum(1.000000000000000);
        dialogInputMeanMobilityPerDay->setMaximum(100.000000000000000);
        dialogInputMeanMobilityPerDay->setSingleStep(0.100000000000000);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label17_2->setText(QCoreApplication::translate("Dialog", "averageMobilityPerDay (km)", nullptr));
