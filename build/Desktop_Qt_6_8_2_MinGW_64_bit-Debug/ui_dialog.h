...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        paginationDialog->setGeometry(QRect(10, 250, 371, 161));
        ...
        dialogInputDI->setGeometry(QRect(100, 110, 71, 30));
        ...
        dialogInputDR->setGeometry(QRect(200, 110, 71, 30));
        ...
        label10_2->setGeometry(QRect(100, 90, 31, 16));
        label11_2 = new QLabel(sirPageDialog);
        label11_2->setObjectName("label11_2");
        label11_2->setGeometry(QRect(200, 90, 31, 16));
        label12_2 = new QLabel(sirPageDialog);
        label12_2->setObjectName("label12_2");
        label12_2->setGeometry(QRect(0, 0, 111, 16));
        dialogInputH = new QDoubleSpinBox(sirPageDialog);
        dialogInputH->setObjectName("dialogInputH");
        dialogInputH->setEnabled(false);
        dialogInputH->setGeometry(QRect(0, 20, 91, 30));
        dialogInputH->setMinimum(0.010000000000000);
        dialogInputH->setMaximum(100.000000000000000);
        dialogInputH->setSingleStep(0.100000000000000);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label12_2->setText(QCoreApplication::translate("Dialog", "h", nullptr));
