...
public:
    ...
    QLabel *label16;
    QDoubleSpinBox *inputAgentMeanMobility;
    QLabel *label17;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MapContainer->setMouseTracking(true);
        ...
        inputBeta->setDecimals(3);
        inputBeta->setMaximum(1.000000000000000);
        inputBeta->setSingleStep(0.001000000000000);
        ...
        inputAgentMeanMobility = new QDoubleSpinBox(agentPage);
        inputAgentMeanMobility->setObjectName("inputAgentMeanMobility");
        inputAgentMeanMobility->setGeometry(QRect(120, 110, 91, 30));
        inputAgentMeanMobility->setFocusPolicy(Qt::WheelFocus);
        inputAgentMeanMobility->setLocale(QLocale(QLocale::German, QLocale::Germany));
        inputAgentMeanMobility->setDecimals(3);
        inputAgentMeanMobility->setMinimum(0.001000000000000);
        inputAgentMeanMobility->setMaximum(100.000000000000000);
        inputAgentMeanMobility->setSingleStep(0.001000000000000);
        label17 = new QLabel(agentPage);
        label17->setObjectName("label17");
        label17->setGeometry(QRect(120, 80, 131, 30));
        label17->setFocusPolicy(Qt::NoFocus);
        ...
        label15 = new QLabel(OptionsBackground);
        label15->setObjectName("label15");
        label15->setGeometry(QRect(170, 350, 101, 30));
        inputAgentArea = new QDoubleSpinBox(OptionsBackground);
        inputAgentArea->setObjectName("inputAgentArea");
        inputAgentArea->setGeometry(QRect(170, 380, 91, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label17->setText(QCoreApplication::translate("MainWindow", "avgMobilityPerDay (km)", nullptr));
