...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label8->setGeometry(QRect(120, 70, 151, 16));
        label9 = new QLabel(sirPage);
        label9->setObjectName("label9");
        label9->setGeometry(QRect(0, 90, 31, 16));
        inputDiffusionS = new QDoubleSpinBox(sirPage);
        inputDiffusionS->setObjectName("inputDiffusionS");
        inputDiffusionS->setGeometry(QRect(0, 110, 71, 30));
        inputDiffusionS->setMaximum(1.000000000000000);
        inputDiffusionS->setSingleStep(0.010000000000000);
        inputDiffusionI = new QDoubleSpinBox(sirPage);
        inputDiffusionI->setObjectName("inputDiffusionI");
        inputDiffusionI->setGeometry(QRect(100, 110, 71, 30));
        inputDiffusionI->setMaximum(10.000000000000000);
        inputDiffusionI->setSingleStep(0.010000000000000);
        inputDiffusionR = new QDoubleSpinBox(sirPage);
        inputDiffusionR->setObjectName("inputDiffusionR");
        inputDiffusionR->setGeometry(QRect(200, 110, 71, 30));
        inputDiffusionR->setMaximum(10.000000000000000);
        inputDiffusionR->setSingleStep(0.010000000000000);
        label10 = new QLabel(sirPage);
        label10->setObjectName("label10");
        label10->setGeometry(QRect(100, 90, 31, 16));
        label11 = new QLabel(sirPage);
        label11->setObjectName("label11");
        label11->setGeometry(QRect(200, 90, 31, 16));
        label12 = new QLabel(sirPage);
        label12->setObjectName("label12");
        label12->setGeometry(QRect(0, 0, 111, 16));
        inputh = new QDoubleSpinBox(sirPage);
        inputh->setObjectName("inputh");
        inputh->setGeometry(QRect(0, 20, 91, 30));
        inputh->setMinimum(0.010000000000000);
        inputh->setMaximum(100.000000000000000);
        inputh->setSingleStep(0.100000000000000);
        ...
        inputAgentHotspotRadius->setMinimum(0.010000000000000);
        ...
        font2.setBold(false);
        fileSelectButton->setFont(font2);
        ...
        iterationLabelChart2->setFont(font3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label12->setText(QCoreApplication::translate("MainWindow", "h", nullptr));
